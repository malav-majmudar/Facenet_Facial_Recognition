...
facenet_model = load_model('/home/jawabreh/Desktop/Face-Recognition/new.h5')

# Load face embeddings
data = np.load(
    '/home/jawabreh/Desktop/Face-Recognition/embeddings/Embeddings.npz')
...
results_df = pd.DataFrame(
    columns=['filename', 'predicted_identity', 'confidence'])
...
for filename in os.listdir(image_dir):
    ...
    results_df = results_df.append(
        {'filename': filename, 'predicted_identity': predicted_identity, 'confidence': confidence}, ignore_index=True)

# Save the results to an Excel sheet
results_df.to_excel(
    '/home/jawabreh/Desktop/Face-Recognition/evaluation/accuracy/Unknown-accuracy-results.xlsx', index=False)
